...
public class BudgetFragment extends Fragment {
    ...
    private void refeshList() {
        budgetList.clear();
        categoryNames.clear();
        budgetList.addAll(budgetDao.getBudgetByUser(currentUserId));
        for (Budget budget : budgetList) {
            Category category = categoryDao.getById(budget.getCategoryId());
            categoryNames.add(category == null ? "Unknown" : category.getName());
        }
    ...
    public void showDeleteDialog(Budget budget) {
